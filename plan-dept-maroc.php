						 ...
						 <div class="developpement">
						 	<div>
								...
								$pays = 153;
									...
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$appartement.'.php">'.TEXTE_42.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$chambre.'.php">'.TEXTE_43.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$maison.'.php">'.TEXTE_44.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$villa.'.php">'.TEXTE_45.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$chateau.'.php">'.TEXTE_46.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$manoir.'.php">'.TEXTE_47.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$hebergement.'.php">'.TEXTE_48.' '.TEXTE_18.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-maroc-'.$domicile.'.php">'.TEXTE_49.' '.TEXTE_18.'</a></li>';
								?>
								</ul>
							</div>
						 </div>
