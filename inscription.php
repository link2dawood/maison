				...
				<tr>
					...
					<td>
						 <div class="developpement">
						 	<p style="text-align:justify;"><?php echo TEXTE_1; ?></p>
						 	<table id="form_inscription">
						 		<tr>
						 			<td class="img"><img src="<?php echo HTTP_IMAGE; ?>clefs.jpg" alt="<?php echo ATTRIBUT_ALT; ?>"/></td>
						 			<td>
						 				<div id="formulaire_inscription"><?php include(INCLUDE_FORMULAIRE_INSCRIPTION); ?></div>
						 			</td>
						 		</tr>
						 	</table>
						 </div>
