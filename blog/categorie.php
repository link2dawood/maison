...
includeLanguage(RACINE, LANGUAGE, FILENAME_BLOG_CATEGORIE);

//Selectionner une catégorie
$categorie = $metier->getChamps("cat",TABLE_BLOG_CATEGORIES.LANGUAGE,"id_cat",$_GET['cat']);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title><?php echo $categorie; ?></title>
	<meta name="description" content="<?php echo TEXTE_1; ?> <?php echo $categorie; ?> <?php echo TEXTE_2; ?>"/>
	<meta name="keywords" content="<?php echo $categorie; ?>,<?php echo HEADER_KEYWORDS; ?>"/>
			...
			<table id="tiers">
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement"><?php echo $categorie; ?></div>
						 		...
						 		<tr>
						 			...
						 			<td class="categories">
						 				<div class="blogCategories">
											<ul>
												<li class="top"><?php echo $categorie; ?></li>
												<?php
												//Développement du titre des articles d'une catégorie
												$blog->listerTitresArticlesBlog($_GET['cat']);
												?>
											</ul>
										</div>
						 			</td>
						 			...
						 			<td class="contenu">
						 				<?php
						 				//Recupérer le dernier article de la catégorie
						 				$article = $blog->getDernierArticleBlog($_GET['cat']);
						 				echo '<div class="titre_article">'.$article->titre_article.'</div>';
						 				echo '<div class="texte_article">'.$article->texte_article.'</div>';
						 				?>
						 			</td>
						 		</tr>
						 	</table>
