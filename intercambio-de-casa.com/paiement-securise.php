...
includeLanguage(RACINE, LANGUAGE, FILENAME_PAIEMENT_SECURISE);
?>
				...
				<tr>
					...
					<td>
						 <div class="developpement">
						 	<p style="font-size:16px;font-weight:bolder;text-align:center;margin-top:100px;"><?php echo TEXTE_1; ?></p>
						 </div>
					</td>
					<!-- PARTIE TCHAT -->
					<td>
