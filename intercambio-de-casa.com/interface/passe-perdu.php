					...
					<td>
						 ...
						 <?php
							...
							echo '<form action="'.HTTP_SERVEUR.'interface/'.FILENAME_PASSE_PERDU.'" method="post">' .
									...
									'<input type="submit" name="valider" value="Enviar mi contraseña"/>' .
									'</div>' .
									'</form>';
							}
							else{
								...
								elseif($ControleBaseEmail > 0){
									...
									$contenu='<h1 style="text-align:center;">INTERCAMBIO-DE-CASA.COM</h1>' .
												'<br /><br />Hola,' .
												'<br /><br />Informaciones:' .
												'<br /><span style="text-decoration:underline;">Login :</span> <strong>'.$getPseudo.'</strong>' .
												'<br /><span style="text-decoration:underline;">Contraseña :</span> <strong>'.$getPasse.'</strong>' .
												'<br /><br />Todo el equipo de www.intercambio-de-casa.com gracias por vuestra confianza.' .
												'<br />' .
						...
						<div class="tchat">
							...
							<div class="monTchat">
								...
								if(empty($_SESSION['pseudo_client'])){
									...
									echo '<div class="img_invitation_hors_connexion"><a href="'.HTTP_SERVEUR.'"><img src="'.HTTP_IMAGE.'bt_inscription.jpg" alt="'.ATTRIBUT_ALT.'"/></a></div>';
								}
								else{
