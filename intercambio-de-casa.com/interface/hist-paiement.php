...
includeLanguage(RACINE, LANGUAGE, FILENAME_HISTORIQUE_PAIEMENT);
?>
						 ...
						 <div class="developpement">
						 	...
						 	if(empty($_SESSION['pseudo_client'])){
						 		...
						 		if($paiement == 0){
									...
									$TotalMembres = $membre->compterUnElement(TABLE_HISTORIQUE_PAIEMENT,"pseudo",$_SESSION['pseudo_client']);
									...
									echo '<div id="divBlacklist">' .
											...
											'<tr>' .
											'<th>'.REF_HIST.'</th>' .
											'<th>'.DATE_ENRG_HIST.'</th>' .
											'<th>'.DATE_CLOTURE_HIST.'</th>' .
											'<th>'.TYPE_ABONNEMENT_HIST.'</th>' .
											'<th>'.ABONNEMENT_HIST.'</th>' .
											'</tr>';
									...
									//**********************************************************************************
									if($TotalMembres > 0){
										echo $membre->afficherHistoriquePaiement($premierMembresAafficher, $nombreMembresParPage, $_SESSION['pseudo_client']);
									}
									else{
									...
									if (isset($page)){
										if ($page<=$nombreDePages){
											...
											echo "<meta http-equiv=\"refresh\" content=\"1; URL=".HTTP_SERVEUR.'interface/'.FILENAME_HISTORIQUE_PAIEMENT."?page=".$nombreDePages."\">";
										}
									}
									?>
									<!-- PAGINATION -->
									<div id="barre_pagination">
										<table style="width:100%;">
											<tr>
												...
												echo '<form action="'.HTTP_SERVEUR.'interface/'.FILENAME_HISTORIQUE_PAIEMENT.'" method="get">' .
									...
									<p style="text-align:justify;font-style:italic;color:red;margin-top:7px;font-weight:bolder;"><?php echo MESSAGE_INFO; ?></p>
									<?php
								}
						 	}
						 	?>
