...
<head>
    <title><?php echo $type_echange; ?> <?php echo TEXTE_24; ?> <?php echo TEXTE_58; ?></title>
	<meta name="description" content="<?php echo $type_echange; ?> <?php echo TEXTE_24; ?> <?php echo TEXTE_58; ?>"/>
...
<div id="exterieur">
	<div id="grey_back">
		...
		<div id="entete">
			...
			<h1><?php echo $type_echange; ?> <?php echo TEXTE_24; ?> <?php echo TEXTE_58; ?></h1>
		</div>
		<!-- MENU -->
			...
			<table id="tiers">
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement"><?php echo $type_echange; ?> <?php echo TEXTE_24; ?> <?php echo TEXTE_58; ?></div>
					...
					<td>
						 <div class="developpement">
						 	<div id="dept_country">
								<ul>
								<?php
								$rech->extraireDept(minuscule($_GET['type']), 96);
								?>
								</ul>
							</div>
						 </div>
