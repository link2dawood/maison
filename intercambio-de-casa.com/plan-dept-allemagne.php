...
<head>
    <title><?php echo TEXTE_50; ?></title>
	<meta name="description" content="<?php echo TEXTE_51; ?>"/>
	<meta name="keywords" content="<?php echo TEXTE_22; ?>"/>
			...
			<table id="tiers">
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement"><?php echo TEXTE_50; ?></div>
						 ...
						 <div class="developpement">
						 	<div>
								...
								if($rech->compterTypeEnLigne($pays,$appartement) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$appartement.'.php">'.TEXTE_42.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$chambre) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$chambre.'.php">'.TEXTE_43.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$maison) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$maison.'.php">'.TEXTE_44.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$villa) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$villa.'.php">'.TEXTE_45.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$chateau) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$chateau.'.php">'.TEXTE_46.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$manoir) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$manoir.'.php">'.TEXTE_47.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$hebergement) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$hebergement.'.php">'.TEXTE_48.' '.TEXTE_22.'</a></li>';
								}
								
								if($rech->compterTypeEnLigne($pays,$domicile) != 0){
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.png" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$domicile.'.php">'.TEXTE_49.' '.TEXTE_22.'</a></li>';
								}
								?>
								</ul>
							</div>
