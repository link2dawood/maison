...
includeLanguage(RACINE, LANGUAGE, FILENAME_MOTEUR_MAISON);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title><?php echo HEADER_TITLE; ?> <?php echo textFormater($_GET['Rechercher']); ?></title>
	<meta name="description" content="<?php echo HEADER_DESCRIPTION; ?> <?php echo textFormater($_GET['Rechercher']); ?> <?php echo HEADER_DESCRIPTION_1; ?>"/>
	<meta name="keywords" content="<?php echo textFormater($_GET['Rechercher']); ?>,<?php echo HEADER_KEYWORDS; ?>"/>
...
<div id="exterieur">
	<div id="grey_back">
		...
		<div id="entete">
			...
			<h1><?php echo textFormater($_GET['Rechercher']); ?></h1>
		</div>
		<!-- MENU -->
				...
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement">
							<?php
							//MAJ PAGINATION
							$element = majPagination(NOMBRE_ANNONCE_PAR_PAGE, $maison->compterNombreMotCle(textFormater($_GET['Rechercher'])));
							...
							if (isset($page)){
								...
								//ON NE FAIT RIEN...
									...
									echo '<meta http-equiv="refresh" content="0; URL='.HTTP_SERVEUR.FILENAME_MOTEUR_MAISON.'?page='.$nombreDePages.'&Rechercher='.supprimerPreposition($_GET['Rechercher']).'">';
								}
							}
							?>	
							<div id="pagination">
								<table class="navigation">
									<tr>
										<td class="li_1">
											...
											echo '<form action="'.HTTP_SERVEUR.FILENAME_MOTEUR_MAISON.'" method="get">' .
												'<input type="hidden" name="page" value="'.$num.'"/>' .
												'<input type="hidden" name="Rechercher" value="'.supprimerPreposition($_GET['Rechercher']).'"/>' .
												'<input type="submit" value="'.BOUTON_RETOUR_PAGINATION.'" '.$disabled.'/>' .
												'</form>';
											?>
										</td>
										<td class="li_2"><?php echo $maison->compterNombreMotCle(textFormater($_GET['Rechercher'])).NOMBRE_RESULTAT; ?></td>
				...
				<tr>
					...
					<td>
						 <div class="developpement">
						 	<div id="col_central"><?php include(INCLUDE_LISTING_RECHERCHE_PAR_MOTS_CLES); ?></div>
						</div>
					</td>
					<!-- PARTIE TCHAT -->
					<td>
