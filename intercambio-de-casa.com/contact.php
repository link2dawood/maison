						 ...
						 <div class="developpement">
							...
							$aVerifier = $_POST['image'];
								...
								if($aVerifier != $verifSpam){
									echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />Lo siento, pero el código <span style="font-weight:bolder;color:red;font-size:16px;">'.$aVerifier.'</span> es no bueno.');
									...
									if (isset($Email)){
										...
										if ($verifEmail == 1){
											...
											echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />Felicidades <br />Vuestro mensaje ha sido enviado.<br/>Vuestro mensaje será procesado tan pronto como sea posible y le responderemos con este correo electrónico <span style="text-decoration:underline;color:red;font-weight:bolder;">'.$Email.'</span><br /><br />Gracias por vuestra confianza');
											redirection(3, HTTP_SERVEUR);
										}
										else{
											echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />Lo siento pero este correo electrónico <span style="font-weight:bolder;color:red;font-size:16px;">'.$Email.'</span> no esta correcto.');
											redirection(3, HTTP_SERVEUR.FILENAME_CONTACT);
										}
									}
									else
									{
										echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />Lo siento, pero se ha producido un error.');
										redirection(3, HTTP_SERVEUR.FILENAME_CONTACT);
									}
								}
							}
