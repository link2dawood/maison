					...
					<td>
						 <div class="developpement">
						 	<ul>
								...
								<li style="padding-top:10px;"><img src="<?php echo HTTP_IMAGE; ?>fleche_gauche.png" alt="<?php echo ATTRIBUT_ALT; ?>" /> <a href="<?php echo HTTP_MOTEUR_MAISON; ?>index.php?page=1" title="<?php echo TEXTE_9; ?>"><?php echo TEXTE_9; ?></a></li>
