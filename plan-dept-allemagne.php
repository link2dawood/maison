						 ...
						 <div class="developpement">
						 	<div>
								...
								$pays = 6;
									...
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$appartement.'.php">'.TEXTE_42.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$chambre.'.php">'.TEXTE_43.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$maison.'.php">'.TEXTE_44.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$villa.'.php">'.TEXTE_45.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$chateau.'.php">'.TEXTE_46.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$manoir.'.php">'.TEXTE_47.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$hebergement.'.php">'.TEXTE_48.' '.TEXTE_22.'</a></li>';
									echo '<li style="padding-top:10px;"><img src="'.HTTP_IMAGE.'fleche_gauche.gif" alt="'.ATTRIBUT_ALT.'" /> <a href="'.HTTP_SERVEUR.'departements-allemagne-'.$domicile.'.php">'.TEXTE_49.' '.TEXTE_22.'</a></li>';
								?>
								</ul>
							</div>
						 </div>
