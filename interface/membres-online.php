...
includeLanguage(RACINE, LANGUAGE, FILENAME_MEMBRE_ONLINE);
				...
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement">
							<?php
							//MAJ PAGINATION
							$element = majPagination(NOMBRE_ANNONCE_PAR_PAGE, $membre->compterMembresOnline($table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste"));
							...
							if (isset($page)){
								...
								//ON NE FAIT RIEN...
									...
									echo '<meta http-equiv="refresh" content="0; URL='.HTTP_SERVEUR.'interface/'.FILENAME_MEMBRE_ONLINE.'?page='.$nombreDePages.'&type='.minuscule($_GET['type']).'&choix_pays='.minuscule($_GET['choix_pays']).'">';
								}
							}
							?>	
							<div id="pagination">
								<table class="navigation">
									<tr>
										<td class="li_1">
											...
											echo '<form action="'.HTTP_SERVEUR.'interface/'.FILENAME_MEMBRE_ONLINE.'" method="get">' .
										...
										<td class="li_2"><?php echo $membre->compterMembresOnline($table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste").NOMBRE_RESULTAT; ?></td>
				...
				<tr>
					...
					<td>
						 <div class="developpement">
						 	<div id="col_central"><?php include(INCLUDE_LISTING_MEMBRES_ONLINE); ?></div>
						 </div>
					</td>
					<!-- PARTIE TCHAT -->
					<td>
