								...
								if(empty($_GET['action'])){
									...
									if (isset($page)){
										if ($page<=$nombreDePages){
											...
											echo "<meta http-equiv=\"refresh\" content=\"0; URL=".HTTP_SERVEUR.'interface/'.FILENAME_BLACKLIST."?page=".$nombreDePages."&action=".$_GET['action']."\">";
										}
									}
									//--------- PAGINATION ---------------
								 ...
								 elseif($_GET['action'] == "supprimer"){
								 	...
								 	redirection(RAFRAICHISSEMENT_MESSAGES_MESSENGER, HTTP_SERVEUR.'interface/'.FILENAME_BLACKLIST);
								 }
								 else{
								 	//ERREUR...
