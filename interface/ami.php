				...
				<tr>
					...
					if(empty($_POST['email_form']) OR $_POST['email_form'] == "........@........"){
						...
						//CAS 3 : TOUT EST OK....
							...
							if(LANGUAGE == "fr"){
								$contenu='<h1 style="text-align:center;">INVITATION</h1>' .
										'<br /><br />Bonjour,' .
										'<br />Vous recevez ce message  invitation pour découvrir notre site !' .
										'<br /><br />Nous sommes heureux de vous présenter notre site d\'échange de logements et d\'hébergement pour des vacances gratuites www.vacanceshome.com !' .
										'<br />Notre site propose les échange de logements pour les vacances comme un échange de maison, chambre, appartement, etc... mais aussi d\'hébergement avec messages audio, vidéo et bien d\'autres choses que nous vous invitons à découvrir.' .
										'<br /><br />Toute l\'équipe de www.vacanceshome.com vous remercie de votre confiance et vous dit "A bientôt et bonnes vacances !!!".' .
										'<br />Pour de petites dépenses mais de grandes vacances: www.vacanceshome.com' .
										'<br />' .
										'<br /><h3 style="text-align:center;">NE PAS REPONDRE - MAIL AUTOMATIQUE</h3>';
							}
							
							if(LANGUAGE == "en"){
								$contenu='<h1 style="text-align:center;">INVITATION</h1>' .
										'<br /><br />Hi,' .
										'<br />I have this message because one of yours friends have sent to you this invitation to discover our website !' .
										'<br /><br />We are so pleased to present you our website of home exchange and free accomodation www.home-exchange.biz !' .
										'<br />Our website suggests you to exchange your house, apartment, room, etc...for holidays but also free accomodation with audio message, video and more...' .
										'<br /><br />All the team of www.home-exchange.biz thanks you so much for your trust !".' .
										'<br />' .
										'<br /><h3 style="text-align:center;">DO NOT RESPONSE - AUTOMATIC MAIL</h3>';
							}
