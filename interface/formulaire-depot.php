							...
							<td colspan="2" id="area">
								<?php
									if(empty($annonce->commentaire1)){
										...
										$com = $annonce->commentaire1;
									}
								?>
								<textarea name="requiredCommentaire1"><?php echo $com; ?></textarea>
							</td>
							<td colspan="2" id="area">
								<?php
									if(empty($annonce->commentaire2)){
										...
										$com1 = $annonce->commentaire2;
									}
								?>
								<textarea name="requiredCommentaire2"><?php echo $com1; ?></textarea>
							</td>
						</tr>
					</table>
				</td>
