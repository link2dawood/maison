					...
					<td>
						 ...
						 <?php
							...
							echo '<form action="'.HTTP_SERVEUR.'interface/'.FILENAME_PASSE_PERDU.'" method="post">' .
									...
									'<input type="submit" name="valider" value="Envoyer mes identifiants"/>' .
									'</div>' .
									'</form>';
							}
							else{
								...
								elseif($ControleBaseEmail > 0){
									...
									if(LANGUAGE == "fr"){
										$contenu='<h1 style="text-align:center;">IDENTIFIANTS DE CONNEXION</h1>' .
												'<br /><br />Bonjour,' .
												'<br />Vous recevez ce message suite à notre formulaire de soumission sur lequel vous avez souhaité recevoir à nouveau vos identifiants de connexion sur notre www.echange-maison.biz' .
												'<br /><br />Voici ci-dessous vos identifiants:' .
												'<br /><span style="text-decoration:underline;">Pseudo :</span> <strong>'.$getPseudo.'</strong>' .
												'<br /><span style="text-decoration:underline;">Mot de passe :</span> <strong>'.$getPasse.'</strong>' .
												'<br /><br />Toute l\'équipe de www.echange-maison.biz vous remercie de votre confiance.' .
												'<br />' .
