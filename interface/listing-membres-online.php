...
//RECHERCHE DU LISTING
	...
	$total = $membre->compterMembresOnline($table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste");
	...
	//**********************************************************************************
	if($total > 0){
		echo $metier->afficherExtraitAnnoncesOnline($premierMembresAafficher, $nombreMembresParPage, $table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste");
	}
	else{
