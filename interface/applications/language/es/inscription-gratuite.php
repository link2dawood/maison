<?php
session_start();
define('HEADER_TITLE', 'Inscrivez-vous gratuitement : echange-maison.biz &trade;');
...
define('FORMULAIRE_ERREUR_DATE_DE_NAISSANCE', 'Nous sommes dsols mais la date de naissance n\'est pas valide.');
define('FORMULAIRE_ERREUR_DATE_DE_NAISSANCE_FORMAT', 'Nous sommes dsols mais le format de la date de naissance n\'est pas valide (JJ/MM/AAAA).');
...
define('FORMULAIRE_ERREUR_PAYS_NON_SELECTIONNE', 'Nous sommes dsols mais le pays slectionn n\'est pas valide!.');
define('FORMULAIRE_ERREUR_DEPARTEMENT_NON_SELECTIONNE', 'Nous sommes dsols mais le dpartement slectionn n\'est pas valide pour ce pays!.');
define('FORMULAIRE_ERREUR_DATE_DE_NAISSANCE_MINEUR', 'Nous sommes dsols mais vous tes mineur, vous ne pouvez pas entrer sur le site.');
