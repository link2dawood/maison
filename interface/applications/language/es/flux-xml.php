<?php
session_start();
define('TEXTE_1', 'Echanger votre logement pour les vacances ou couchsurfing.');
define('TEXTE_2', 'Plus de 240 pays sont rpertoris pour 8 choix d\'changes: maison, appartement, chambre etc...');
define('TEXTE_3', 'Site d\'change de maison et couchsurfing');
...
define('TEXTE_20', 'Echange de maison, couch surfing et location de vacances');
...
define('TEXTE_25', 'Echange maison et couch surfing: voyager malin... c\'est voyager gratuit!');
define('TEXTE_26', 'Visitez nos annonces d\'changes de logements et couch surfing du monde entier! Plus de 240 pays au choix...');
