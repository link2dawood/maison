...
define('HEADER_DESCRIPTION', 'Devenez membre de notre site change de maison et d\'hbergement pour des vacances gratuites');
...
define('MON_ANNONCE_LIBELLE_COUCHSURFING', 'Hbergement');
...
define('MON_COMPTE_DESCRIPTION', HTTP_WARNING.' Vous pouvez  tout moment vous dsinscrire du site vacanceshome.com. Par cette action, votre compte sera totalement supprim et vous devrez vous rinscrire pour revenir sur notre site.');
