...
<table id="compte_client">
	...
	<tr>
		<td>Paiement :</td>
		<td class="donnees_paiement"><?php echo $paiement;?></td>
	</tr>
	<tr>
		<td>Email :</td>
		<td class="donnees"><?php echo $info_membre->email;?></td>
	</tr>
	<tr>
		<td>Ip : </td>
	...
	<?php
		if($info_membre->id_annonce){
			...
			<tr>
				...
				<td class="donnees"><?php echo $statut;?></td>
			</tr>
			<?php
		}
		?>
	<tr>
		<td>Compte actif :</td>
		<td class="donnees"><?php echo $actif;?></td>
	</tr>
</table>
<?php
if($info_membre->id_annonce){
	//ANNONCE PRESENTE
	include(INCLUDE_ADMIN_ANNONCE);
}
?>