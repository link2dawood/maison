...
includeLanguage(RACINE, LANGUAGE, FILENAME_COMMENTAIRES);
?>
				...
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement">
							<?php
							//MAJ PAGINATION
							$element = majPagination(NOMBRE_ANNONCE_PAR_PAGE, $membre->compterUnElement(TABLE_LIVRE_DOR,"accepter_message","ok"));
							...
							if (isset($page)){
								...
								//ON NE FAIT RIEN...
									...
									echo '<meta http-equiv="refresh" content="0; URL='.HTTP_COMMENTAIRES.'?page='.$nombreDePages.'">';
								}
							}
							?>	
							<div id="pagination">
								<table class="navigation">
									<tr>
										<td class="li_1">
											...
											echo '<form action="'.HTTP_COMMENTAIRES.'" method="get">' .
												'<input type="hidden" name="page" value="'.$num.'"/>' .
												'<input type="submit" value="'.BOUTON_RETOUR_PAGINATION.'" '.$disabled.'/>' .
												'</form>';
											?>
										</td>
										<td class="li_2"><?php echo $membre->compterUnElement(TABLE_LIVRE_DOR,"accepter_message","ok").NOMBRE_RESULTAT; ?></td>
				...
				<tr>
					...
					<td>
						<div class="developpement">
						 	<div id="col_central"><?php include(INCLUDE_LISTING_COMMENTAIRES); ?></div>
						</div>
					</td>
					<!-- PARTIE TCHAT -->
					<td>
