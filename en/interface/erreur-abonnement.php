...
includeLanguage(RACINE, LANGUAGE, FILENAME_PAIEMENT_ABO_REFUSE);

//RECEPTION DES DONNEES
$email = minuscule($_GET['mb']);
						 	...
						 	if(empty($_SESSION['pseudo_client'])){
								...
								if(empty($email) AND empty($identifiant)){
									...
									if(empty($confirm)){
										...
										$membre->supprimerUnElement(TABLE_PAIEMENT_ATTENTE_CONFIRMATION, "email", $email);
