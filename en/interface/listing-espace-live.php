...
//RECHERCHE DU LISTING
	...
	$total = $metier->compterMembresSuivantOptions($table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste");
	...
	//**********************************************************************************
	if($total > 0){
		echo $metier->afficherExtraitOFFLINEetONLINEAnnoncesAvecOptions($premierMembresAafficher, $nombreMembresParPage, $table,minuscule($_GET['type']),minuscule($_GET['choix_pays']),"liste");
	}
	else{
