...
echo '<?xml version="1.0" encoding="iso-8859-1"?>' .
		...
		'<item>' .
		'<title>'.TEXTE_4.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-1-4.php</link>' .
		'<description>'.TEXTE_5.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_6.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-2-4.php</link>' .
		'<description>'.TEXTE_7.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_8.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-3-4.php</link>' .
		'<description>'.TEXTE_9.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_10.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-4-4.php</link>' .
		'<description>'.TEXTE_11.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_12.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-5-4.php</link>' .
		'<description>'.TEXTE_13.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_14.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-6-4.php</link>' .
		'<description>'.TEXTE_15.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_16.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-7-4.php</link>' .
		'<description>'.TEXTE_17.'</description>' .
		'</item>' .
		'<item>' .
		'<title>'.TEXTE_18.'</title>' .
		'<link>'.HTTP_SERVEUR.'petites-annonces-echange-maison-1-8-4.php</link>' .
