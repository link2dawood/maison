			...
			<table id="tiers">
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement"><?php echo TEXTE_3; ?></div>
					...
					<td>
						 <div class="developpement">
						 	...
						 	echo '<table id="tabListMoteur">' .
						 					'<tr>' .
						 					'<td>';
						 			$listing_pays = $metier->afficherTousLesPays(LANGUAGE,0,50,3);
						 			foreach($listing_pays as $cle){
						 				echo $cle;
						 			}
						 			echo '</td>' .
						 					'<td>';
						 			$listing_pays_1 = $metier->afficherTousLesPays(LANGUAGE,50,50,3);
						 			foreach($listing_pays_1 as $cle){
						 				echo $cle;
						 			}
						 			echo '</td>' .
						 					'<td>';
						 			$listing_pays_2 = $metier->afficherTousLesPays(LANGUAGE,100,50,3);
						 			foreach($listing_pays_2 as $cle){
						 				echo $cle;
						 			}	
						 			echo '</td>' .
						 					'<td>';
						 			$listing_pays_3 = $metier->afficherTousLesPays(LANGUAGE,150,50,3);
						 			foreach($listing_pays_3 as $cle){
						 				echo $cle;
						 			}
						 			echo '</td>' .
						 					'<td>';
						 			$listing_pays_4 = $metier->afficherTousLesPays(LANGUAGE,200,50,3);
