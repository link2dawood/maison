						 ...
						 <div class="developpement">
							...
							$aVerifier = $_POST['image'];
								...
								if($aVerifier != $verifSpam){
									echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />We are sorry but the antispam code <span style="font-weight:bolder;color:red;font-size:16px;">'.$aVerifier.'</span> is not right!');
									...
									if (isset($Email)){
										...
										if ($verifEmail == 1){
											...
											$codehtml=
											"<html><body>" .
											"<h1 style=\"text-align:center;\">FORMULAIRE DE CONTACT<br />(home-exchange-biz)</h1><br/>".
											...
											echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />Congratulations <br />Your message has been successfully submitted !<br/>Your request will be processed as quickly as possible and we will reply via your email address <span style="text-decoration:underline;color:red;font-weight:bolder;">'.$Email.'</span><br /><br />Thank you for your trust!');
											redirection(3, HTTP_SERVEUR);
										}
										else{
											echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />We are sorry but this email <span style="font-weight:bolder;color:red;font-size:16px;">'.$Email.'</span> is not right !');
											redirection(3, HTTP_SERVEUR.FILENAME_CONTACT);
										}
									}
									else
									{
										echo afficherAlerte('<img src="'.HTTP_IMAGE.'progressbar.gif" alt="progressbar" /><br />We are sorry but an error came out !');
										redirection(3, HTTP_SERVEUR.FILENAME_CONTACT);
									}
								}
							}
