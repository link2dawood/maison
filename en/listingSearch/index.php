...
includeLanguage(RACINE, LANGUAGE, FILENAME_LISTING_MOTS_CLES);
?>
                ...
                <tr>
                    ...
                    <td class="titre_developpement">
                        ...
                        <div class="corps_top_developpement">
                            <?php
                            //MAJ PAGINATION
                            $element = majPagination(100, $maison->compterTotalMotsCles());
                            ...
                            if (isset($page)){
                                ...
                                //ON NE FAIT RIEN...
                                    ...
                                    echo '<meta http-equiv="refresh" content="0; URL='.HTTP_LISTING_SEARCH.'index.php?page='.$nombreDePages.'">';
                                }
                            }
                            ?>  
                            <div id="pagination">
                                <table class="navigation">
                                    <tr>
                                        <td class="li_1">
                                            ...
                                            echo '<form action="'.HTTP_LISTING_SEARCH.'" method="get">' .
                                                '<input type="hidden" name="page" value="'.$num.'"/>' .
                                                '<input type="submit" value="'.BOUTON_RETOUR_PAGINATION.'" '.$disabled.'/>' .
                                                '</form>';
                                            ?>
                                        </td>
                                        <td class="li_2"><?php echo $maison->compterTotalMotsCles().NOMBRE_RESULTAT; ?></td>
                ...
                <tr>
                    ...
                    <td>
                         <div class="developpement">
                            <div id="col_central"><?php include(INCLUDE_LISTING_MOTS_CLES); ?></div>
                        </div>
                    </td>
                    <!-- PARTIE TCHAT -->
                    <td>
