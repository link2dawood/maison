...
<head>
    <title><?php echo $type_echange; ?> <?php echo TEXTE_20; ?> <?php echo TEXTE_58; ?></title>
	<meta name="description" content="<?php echo $type_echange; ?> <?php echo TEXTE_20; ?> <?php echo TEXTE_58; ?>"/>
	<meta name="keywords" content="<?php echo TEXTE_58; ?>,<?php echo HEADER_KEYWORDS; ?>"/>
...
<div id="exterieur">
	<div id="grey_back">
		...
		<div id="entete">
			...
			<h1><?php echo $type_echange; ?> <?php echo TEXTE_20; ?> <?php echo TEXTE_58; ?></h1>
		</div>
		<!-- MENU -->
			...
			<table id="tiers">
				<tr>
					...
					<td class="titre_developpement">
						...
						<div class="corps_top_developpement"><?php echo $type_echange; ?> <?php echo TEXTE_20; ?> <?php echo TEXTE_58; ?></div>
					...
					<td>
						 <div class="developpement">
						 	<div id="dept_country">
								...
								<?php
								$pays = 21;
								$rech->extraireDept(minuscule($_GET['type']), $pays);
								?>
								</ul>
							</div>
						 </div>
